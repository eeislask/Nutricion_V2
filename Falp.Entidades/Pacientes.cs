...
{
   public  class Pacientes: Utilidades
    {
       ...
       public string _Apellidos
       {
        ...
        public Pacientes(int id,int correlativo ,int ficha, int folio,string tipo_doc, int num_doc,string nombres,int cod_nhc, string apellidos , int id_pac)
